...
namespace HotelProject.WebUI.Controllers
{
    public class AdminAboutController : Controller
    {
        ...
        public async Task<IActionResult> AdminAboutIndex()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:5240/api/About");          // Belirtilen adrese istekte bulunuldu.
        ...
        public async Task<IActionResult> UpdateAbout(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"http://localhost:5240/api/About/{id}");
        ...
        public async Task<IActionResult> UpdateAbout(UpdateAboutDto updateAboutDto)
        {
            ...
            var responseMessage = await client.PutAsync($"http://localhost:5240/api/About/", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
